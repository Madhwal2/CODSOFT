...
class Dbe {
	...
	Connection con;
	ResultSet rs;
	String update = "update signup set marks=? where id=?";
	String search = "select *from signup where id=?";
	...
	boolean search(String id) throws Exception {
	...
	void updateresults(String marks, String id) throws Exception {
...
public class Quiz implements ActionListener {
	...
	public void results() {
		...
		JLabel details = new JLabel("Enter your ID to save the score" + " ");
		JButton save = new JButton("save");
		JButton exit = new JButton("exit");
		JTextField tx = new JTextField(60);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.setBounds(400, 200, 500, 300);
		frame.setLayout(null);
		tx.setBounds(100, 60, 120, 30);
		save.setBounds(120, 180, 140, 30);
		exit.setBounds(300, 180, 140, 30);
		details.setBounds(100, 20, 120, 100);
		frame.setVisible(true);
		frame.add(details);
		frame.add(tx);
		frame.add(save);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
...

					{
						...
						f.setVisible(true);
						frame.setLayout(null);
						JOptionPane.showMessageDialog(f, "wrong id entered");
						dispose();
					}
